...
exports.create = (req, res) => {
    ...
    const cliente = {
        id_cliente: req.body.id_cliente || null, // si no viene el id_cliente lo dejamos como null
...
exports.update = (req, res) => {
    ...
    Cliente.update(req.body, {
        ...
        .catch(err => {
            res.status(500).send({
                message: "Error updating Client with id=" + id + " " + err.message
            });
        });
};
...
exports.delete = (req, res) => {
    ...
    Cliente.destroy({
        ...
        .catch(err => {
            res.status(500).send({
                message: "Could not delete Client with id=" + id + " " + err.message
            });
        });
};
